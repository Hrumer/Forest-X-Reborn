...
public class VultureRenderer extends GeoEntityRenderer<VultureEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, VultureEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
