...
import ru.power_umc.forestxreborn.entity.model.WaspModel;
...
public class WaspRenderer extends GeoEntityRenderer<WaspEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, WaspEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
