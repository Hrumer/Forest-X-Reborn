...
public class BabyWitherSkeletonRenderer extends GeoEntityRenderer<BabyWitherSkeletonEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, BabyWitherSkeletonEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 1f;
