...
public class BrownBearRenderer extends GeoEntityRenderer<BrownBearEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, BrownBearEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
