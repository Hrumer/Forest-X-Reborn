...
import ru.power_umc.forestxreborn.entity.model.RatModel;
...
public class RatRenderer extends GeoEntityRenderer<RatEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, RatEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
