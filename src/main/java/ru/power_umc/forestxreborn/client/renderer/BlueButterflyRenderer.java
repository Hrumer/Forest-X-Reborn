...
public class BlueButterflyRenderer extends GeoEntityRenderer<BlueButterflyEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, BlueButterflyEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
