...
public class FireSalamanderRenderer extends GeoEntityRenderer<FireSalamanderEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FireSalamanderEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
