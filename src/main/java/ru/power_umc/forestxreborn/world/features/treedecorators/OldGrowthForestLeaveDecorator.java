...
public class OldGrowthForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<OldGrowthForestLeaveDecorator> CODEC = MapCodec.unit(OldGrowthForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("forest:old_growth_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}
