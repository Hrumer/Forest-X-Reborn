...
public class DryThornForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<DryThornForestLeaveDecorator> CODEC = MapCodec.unit(DryThornForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("forest:dry_thorn_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}
