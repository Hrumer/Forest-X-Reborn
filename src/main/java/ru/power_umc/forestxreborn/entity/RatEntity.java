...
public class RatEntity extends Animal implements GeoEntity {
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("CUSTOM:rat.ambient"));
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("CUSTOM:rat.hurt"));
	}
