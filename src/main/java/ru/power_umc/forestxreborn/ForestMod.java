...
public class ForestMod {
	...
	public ForestMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		ForestModSounds.REGISTRY.register(modEventBus);
		ForestModBlocks.REGISTRY.register(modEventBus);
		ForestModBlockEntities.REGISTRY.register(modEventBus);
		ForestModItems.REGISTRY.register(modEventBus);
		ForestModEntities.REGISTRY.register(modEventBus);
		ForestModTabs.REGISTRY.register(modEventBus);
		ForestModVariables.ATTACHMENT_TYPES.register(modEventBus);
		ForestModFeatures.REGISTRY.register(modEventBus);
		StructureFeature.REGISTRY.register(modEventBus);

		ForestModMenus.REGISTRY.register(modEventBus);
