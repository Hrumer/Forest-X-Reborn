...
public abstract class SilverArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 40, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_gold")), () -> Ingredient.of(new ItemStack(ForestModItems.SILVER_INGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("forest:silver"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("forest:silver_armor"), armorMaterial);
