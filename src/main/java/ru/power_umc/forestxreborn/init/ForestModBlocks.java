...
import ru.power_umc.forestxreborn.block.*;
...
public class ForestModBlocks {
	...
	public static final RegistryObject<Block> WOODCUTTER = REGISTRY.register("woodcutter", () -> new WoodCutterBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.5F)));
