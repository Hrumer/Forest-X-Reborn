...
import ru.power_umc.forestxreborn.block.StrippedCharredWoodBlock;
import ru.power_umc.forestxreborn.block.StrippedCharredLogBlock;
...
import ru.power_umc.forestxreborn.block.CharredWoodBlock;
import ru.power_umc.forestxreborn.block.CharredTrapdoorBlock;
import ru.power_umc.forestxreborn.block.CharredStairsBlock;
import ru.power_umc.forestxreborn.block.CharredSlabBlock;
import ru.power_umc.forestxreborn.block.CharredPressurePlateBlock;
import ru.power_umc.forestxreborn.block.CharredPlanksBlock;
import ru.power_umc.forestxreborn.block.CharredParquetBlock;
import ru.power_umc.forestxreborn.block.CharredLogBlock;
import ru.power_umc.forestxreborn.block.CharredFenceGateBlock;
import ru.power_umc.forestxreborn.block.CharredFenceBlock;
import ru.power_umc.forestxreborn.block.CharredDoorBlock;
import ru.power_umc.forestxreborn.block.CharredButtonBlock;
...
public class ForestModBlocks {
	...
	public static final RegistryObject<Block> CHARRED_PARQUET = REGISTRY.register("charred_parquet", () -> new CharredParquetBlock());
	...
	public static final RegistryObject<Block> CHARRED_WOOD = REGISTRY.register("charred_wood", () -> new CharredWoodBlock());
	public static final RegistryObject<Block> STRIPPED_CHARRED_WOOD = REGISTRY.register("stripped_charred_wood", () -> new StrippedCharredWoodBlock());
	public static final RegistryObject<Block> STRIPPED_CHARRED_LOG = REGISTRY.register("stripped_charred_log", () -> new StrippedCharredLogBlock());
	public static final RegistryObject<Block> CHARRED_PLANKS = REGISTRY.register("charred_planks", () -> new CharredPlanksBlock());
	public static final RegistryObject<Block> CHARRED_STAIRS = REGISTRY.register("charred_stairs", () -> new CharredStairsBlock());
	public static final RegistryObject<Block> CHARRED_SLAB = REGISTRY.register("charred_slab", () -> new CharredSlabBlock());
	public static final RegistryObject<Block> CHARRED_FENCE = REGISTRY.register("charred_fence", () -> new CharredFenceBlock());
	public static final RegistryObject<Block> CHARRED_FENCE_GATE = REGISTRY.register("charred_fence_gate", () -> new CharredFenceGateBlock());
	public static final RegistryObject<Block> CHARRED_DOOR = REGISTRY.register("charred_door", () -> new CharredDoorBlock());
	public static final RegistryObject<Block> CHARRED_TRAPDOOR = REGISTRY.register("charred_trapdoor", () -> new CharredTrapdoorBlock());
	public static final RegistryObject<Block> CHARRED_BUTTON = REGISTRY.register("charred_button", () -> new CharredButtonBlock());
	public static final RegistryObject<Block> CHARRED_PRESSURE_PLATE = REGISTRY.register("charred_pressure_plate", () -> new CharredPressurePlateBlock());
