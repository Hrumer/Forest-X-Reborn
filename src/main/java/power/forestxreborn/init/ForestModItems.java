...
public class ForestModItems {
	...
	public static final RegistryObject<Item> TUMBLEWEED_SPAWN_EGG = REGISTRY.register("tumbleweed_spawn_egg", () -> new ForgeSpawnEggItem(ForestModEntities.TUMBLEWEED, -1, -1, new Item.Properties()));
