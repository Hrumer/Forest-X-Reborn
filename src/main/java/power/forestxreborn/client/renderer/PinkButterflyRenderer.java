...
import power.forestxreborn.entity.model.PinkButterflyModel;
...
public class PinkButterflyRenderer extends GeoEntityRenderer<PinkButterflyEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PinkButterflyEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
