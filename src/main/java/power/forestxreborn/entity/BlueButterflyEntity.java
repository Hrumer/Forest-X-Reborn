...
public class BlueButterflyEntity extends PathfinderMob implements GeoEntity {
	...
	public static void init() {
		SpawnPlacements.register(ForestModEntities.BLUE_BUTTERFLY.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
