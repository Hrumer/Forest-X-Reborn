...
public class RacoonEntity extends Animal  {
	...
	@Override protected void registerGoals() {
		super.registerGoals();
            ...
            this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.of(ForestModItems.BLUEBERRY.get()), false));this.goalSelector.addGoal(2, new FollowParentGoal(this, 1));
this.goalSelector.addGoal(3, new BreedGoal(this, 1));
this.goalSelector.addGoal(4, new RemoveBlockGoal(Blocks.CHEST,
        this, 1, (int) 4));this.goalSelector.addGoal(5, new OpenDoorGoal(this, true));
this.goalSelector.addGoal(6, new RandomStrollGoal(this, 1));this.goalSelector.addGoal(7, new RandomLookAroundGoal(this));this.goalSelector.addGoal(8, new FloatGoal(this));this.goalSelector.addGoal(9, new LeapAtTargetGoal(this, (float)0.5));
	...
	public static void init() {
			SpawnPlacements.register(ForestModEntities.RACOON.get(),
